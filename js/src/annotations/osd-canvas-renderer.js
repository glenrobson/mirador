      ...
      jQuery.each(this.overlays, function(index, value) {
        ...
        tinymce.init({
                  ...
                  formats: {
                    ...
                    bat: {inline: 'span', style:{color: "cadetblue"}, attributes: {property: "ns:bat", class: "bat"}},
                    ship: {inline: 'span', style:{color: "green"}, attributes: {property: "ns:ship", class: "ship"}},
                    medal: {inline: 'span', style:{color: "darkgreen"}, attributes: {property: "ns:medal", class: "medal"}}
                  }
                });
    },
